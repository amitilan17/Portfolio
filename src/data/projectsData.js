...
const projectsDataMap = {
    ...
    '2-5': {
        ...
        hebDescription: 'מעטפת גרפית למוסד חדש: ארכיון עירוני הנפתח בבניין המשביר לצרכן בירושלים. במסגרת הפרוייקט עיצבתי לוגו ופוסטרים לאירוע הפתיחה. השפה הגרפית לוקחת השראה מצורת המבנה ומזוויות החלונות שלו, וקורצת גם למטרתו המקורית בשדה הצרכנות.',
        engDescription: '',
